...
echo "
     ...
     <body>
         ...
         <div class=\"contact_section layout_padding\" style=\"height: 51vh; width: 100%;\">
          <h1 class=\"contact_taital\" style=\"margin-top: 50px; \"> System Information: </h1> <h5 class=\"contact_taital_2\" style=\"margin-top: 50px; \">"
uname -a
echo "
        </h5>
         </div>
